  ...
  async fetchUser() {
   ...
   async addStory(){
    if (this.state.caption){
      ...
      Alert.aler("Error","All Fields are required!", [{ text :"OK", onPress: ()=>console.log("OK PRESSED") }],{cancelable : false});
    }
   }
          ...
          <View style={styles.fieldsContainer}>
            <ScrollView>
              ...
              <TextInput
                style={[
                  this.state.light_theme ? styles.inputFontLight : styles.inputFont,
                  styles.inputFontExtra,//this.state.light_theme ? styles.inputFontExtraLight : styles.inputFontExtra
                  styles.inputTextBig//this.state.light_theme ? styles.inputFontBigLight : styles.inputFontBig
                ]}
